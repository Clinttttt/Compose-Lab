...
/// <summary>
/// The outcome of an operation that can fail in an expected way. Handlers return this rather than
/// throwing; unexpected exceptions travel through the global exception handler instead. The two
/// paths never mix.
/// </summary>
public class Result
{
...
/// <summary>A result that carries a value when successful.</summary>
